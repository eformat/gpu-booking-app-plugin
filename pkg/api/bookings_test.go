...
func TestCreateBookingEvictsConsumed(t *testing.T) {
	...
	_, err := db.Exec(
		...
		"consumed-1", "kueue-user", "", "nvidia.com/gpu", 0, date, "full", "now", database.SourceConsumed, "", 0, 24, 0, "unreserved",
	)
	if err != nil {
...
func TestGetBookings(t *testing.T) {
	...
	_, err := db.Exec(
		"INSERT INTO bookings ("+database.BookingColumns+") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
		"booking-1", "testuser", "", "nvidia.com/gpu", 0, today, "full", "now", database.SourceReserved, "desc", 0, 24, 0, "unreserved",
	)
	if err != nil {
...
func TestDeleteBooking(t *testing.T) {
	...
	db.Exec(
		"INSERT INTO bookings ("+database.BookingColumns+") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
		"booking-1", "testuser", "", "nvidia.com/gpu", 0, today, "full", "now", database.SourceReserved, "", 0, 24, 0, "unreserved",
	)
...
func TestDeleteBookingConsumedForbidden(t *testing.T) {
	...
	db.Exec(
		"INSERT INTO bookings ("+database.BookingColumns+") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
		"booking-1", "testuser", "", "nvidia.com/gpu", 0, today, "full", "now", database.SourceConsumed, "", 0, 24, 0, "unreserved",
	)
...
func TestBulkCancelHandler(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		db.Exec(
			"INSERT INTO bookings ("+database.BookingColumns+") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
			"booking-"+string(rune('1'+i)), "testuser", "", "nvidia.com/gpu", i, today, "full", "now", database.SourceReserved, "", 0, 24, 0, "unreserved",
		)
	}
...
func TestBulkCancelHandlerMixedOwnership(t *testing.T) {
	...
	db.Exec(
		"INSERT INTO bookings ("+database.BookingColumns+") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
		"booking-2", "alice", "", "nvidia.com/gpu", 1, today, "full", "now", database.SourceReserved, "", 0, 24, 0, "unreserved",
	)
...
func TestBulkBookingHandlerAllSlotsTaken(t *testing.T) {
	...
	for i := range 8 {
		db.Exec(
			"INSERT INTO bookings ("+database.BookingColumns+") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
			fmt.Sprintf("existing-%d", i), "alice", "", "nvidia.com/gpu", i, date, "full", "now", database.SourceReserved, "", 0, 24, 0, "unreserved",
		)
	}
